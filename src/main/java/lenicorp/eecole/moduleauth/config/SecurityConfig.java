package lenicorp.eecole.moduleauth.config;
...
import lenicorp.eecole.moduleauth.filters.JwtAuthenticationFilter;
        ...
        return httpSecurity
                ...
                .cors(cors -> {
                    CorsConfigurationSource source = request -> {
                        ...
                        config.setAllowedOrigins(Arrays.asList("http://localhost:3000/","http://localhost:8000/","http://localhost/",
