...
import lenicorp.eecole.modulelog.controller.repositories.LogDetailsRepo;
import lenicorp.eecole.modulelog.controller.repositories.LogRepo;
...
import lenicorp.eecole.sharedmodule.utilities.ObjectTypeUtils;
...
public class LogService implements ILogService
{
    ...
    private Page<ConnexionList> getConnexionList(List<String> actions, String connId, String key, Long userId, LocalDate debut, LocalDate fin, Pageable pageable)
    {
        ...
        Page<ConnexionList> connexionPage = logRepo.getConnnexionLogs(actions, key,userId, debut, fin.plusDays(1), connId, codeEcole,pageable);
